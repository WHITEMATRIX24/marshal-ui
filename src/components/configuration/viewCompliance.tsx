...
export function ViewComplianceTable<TData, TValue>({
    columns,
    data,
        ...
        <div>
            <div className="flex justify-end gap-3 py-4">
                <Input
                    ...
                    value={
                        (table.getColumn("compliance_title")?.getFilterValue() as string) ?? ""
                    }
                    onChange={(event) =>
                        table.getColumn("compliance_title")?.setFilterValue(event.target.value)
                    }
