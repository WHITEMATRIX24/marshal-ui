...
const DeleteAssignmentModal: React.FC<DeleteModalProps> = ({
    assignment_id,
    isOpen,
    onClose,
    onDeleteSuccess
    ...
    const deleteControl = async () => {
        console.log("Deleting assignment with ID:", assignment_id); // Debugging line
        ...
        const urlEndpoint = `/assignments/assignments/${assignment_id}`;
        const method = "DELETE";
