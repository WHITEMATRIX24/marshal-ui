    ...
    return (
        <Card>
            <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
                <div className="flex flex-1 flex-col justify-center gap-1 px-2 py-5 sm:py-1">
                    <CardTitle className="text-[14px]">Statistics</CardTitle>
            ...
            <CardContent className="px-2 sm:p-6">
                ...
                >
                    ...
                    >
                        ...
                        />
                        <Bar dataKey={activeChart} fill={`var(--blue)`} />
                    </BarChart>
                </ChartContainer>
            </CardContent>
        </Card>
